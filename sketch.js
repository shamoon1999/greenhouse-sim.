...
function draw() 
{
  ...
  //And the second fan will start when temp >= 30 and power_gen >= 8.
...
//Create function for charge1, charge2 & temp_rise
 function charge1(spr1){
 spr1.remove()
 absorbed1 = absorbed1 + 1;

 }

function charge2(spr1){
spr1.remove()
absorbed2 = absorbed2 + 1;

}
 function temp_rise(spr1){
 spr1.remove();
 temp = temp + 1;
 }
